...
describe('Tree', () => {
  ...
  describe('map()', () => {
    ...
    it('should be a function', () => {
      expect(typeof Tree.prototype.map).toEqual('function');
    });
    ...
    it('should return an identical tree if the mapping function returns the value unaltered', () => {
      ...
      var verifyTree = (result, expectation) => {
    ...
    it('should return a tree with doubled values if the function doubles the value', () => {
